...
// //   var zoomOutIcon =
// //     '<svg class="shadow" width="64" height="64" fill="#9b0000" version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"' +
...
// //   var detailsIcon =
// //     '<svg width="24" height="24" fill="orange" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"' +
// //     'viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">' +
...
// //   var editIcon =
// //     '<svg width="24" height="24" fill="#000097" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"' +
...
// //   var addIcon =
// //     '<svg width="24" height="24" fill="green" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"' +
// //     'viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">' +
...
// //     '<rect x="0" y="0" height="80" width="300" fill="#039BE5" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' +
...
// //     '<rect x="0" y="0" height="80" width="300" fill="#48af56" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' +
...
// //     '<rect x="0" y="0" height="80" width="300" fill="#ffe68d" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' +
...
// //     '<text width="210" class="field_0" style="font-size: 18px;" fill="#757575" x="80" y="30" text-anchor="start">{val}</text>';
// //   OrgChart.templates.yellow.field_1 =
// //     '<text width="210" class="field_1" style="font-size: 14px;" fill="#757575" x="80" y="55" text-anchor="start">{val}</text>';
...
// //   chart.load(nodes);
// // };
// function updateOrgChart(chart, employees) {
//   // Map the database columns to the corresponding fields in the organization chart nodes
...
//   // Update the nodes in the organization chart
...
//     },
//   });
//   // Call the updateOrgChart function passing the chart and employees data
//   updateOrgChart(chart, employees);
// };
...
//     .then(chartData => {
//       // Create OrgChart using chartData
//       var chart = new OrgChart(document.getElementById('tree'), {
//         template: 'olivia',
//         layout: OrgChart.mixed,
//         enableSearch: false,
...
function renderChart(series) {
  return JSC.chart('chartDiv', {
    ...
    defaultPoint: {
      ...
      annotation: {
        label: {
          text: '<b>%position</b><br/>%name<br><img margin_left=-58 margin_top=-39.5 width=50 height=50 src=%photo>',
          autoWrap: false,
          color: 'slategray',
          style: {
            fontWeight: 'normal',
